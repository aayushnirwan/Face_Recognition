...
if __name__ == '__main__':
    ...
    input_dir = "/home/aayush/Project/Facenet/output/intermediate"
    model_path = "/home/aayush/Project/Facenet/Facenet/etc/20170511-185253/20170511-185253.pb"
    classifier_path = "/home/aayush/Project/Facenet/output/classifier.pkl"
    num_threads = 16
    num_epochs = 2
    ...
    main(input_directory=input_dir, model_path=model_path, classifier_output_path=classifier_path,
         batch_size=128, num_threads=num_threads, num_epochs=num_epochs,
         min_images_per_labels=min_num_images_per_class, split_ratio=0.7, is_train=False)
